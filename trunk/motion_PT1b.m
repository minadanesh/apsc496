...
for Theta_r = Theta_r_min : 2*Angle_step : Theta_r_max
    ...
    for Theta_12 = Theta_12_min : Angle_step : Theta_12_max
          ...
          for Theta_5 = 0 : Angle_step : Theta_5_max
              ...
              radial_5r = (Length_3 ^2 + Length_5_eff ^2 - 2 * Length_3 * Length_5_eff * cos(Theta_35)) ^.5;
              Theta_2 = asin(Length_1 * sin(Theta_12) / radial_12) ;
              Theta_5r = 2*pi() - Theta_2 - Theta_23 - asin(Length_5_eff * sin(Theta_35) / radial_5r);
              radial_end = (radial_12 ^2 + radial_5r ^2 - 2 * radial_12 * radial_5r * cos(Theta_5r)) ^.5;
              Theta_end = asin(radial_5r * sin(Theta_5r) / radial_end);
