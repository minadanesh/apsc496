...
int omap_i2c_reset(omap_dev_t *dev){
	 ...
	 */
	out16(dev->regbase+0xC,	0x636f);
	
	out16(dev->regbase + OMAP_I2C_CON, 0);
	
    /* Set clock prescaler, inorder to set Internal clock for the I2C module to 4Mhz */
    out16(dev->regbase + OMAP_I2C_PSC, 23);
...
__SRCVERSION( "$URL: http://svn/product/tags/public/bsp/nto641/ti-omap3530-beagle/1.0.0/src/hardware/i2c/omap35xx/init.c $ $Rev: 249398 $" );
